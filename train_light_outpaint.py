...
def main():
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                model_pred = unet(
                    latent_model_input, timesteps, _encoder_hidden_states
                ).sample
                ...
                if args.snr_gamma is None:
                    ...
                    # loss = F.mse_loss(
                    #     model_pred[mask].float(), target[mask].float(), reduction="mean"
                    # )
                else:
    ...
    if accelerator.is_main_process:
        ...
        unet.save_attn_procs(args.output_dir)  # Save the LoRA layers
